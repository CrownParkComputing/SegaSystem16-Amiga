...
static const char *shinobi_intro_status(void *ctx)
{
    ...
    return "LOADING GOLDEN AXE ROMS";
}
...
static const ai_config shinobi_intro_cfg = {
    "GOLDEN AXE",
    "WHITTY ARCADE PRESENTS GOLDEN AXE    SEGA 1989 SYSTEM 16B HARDWARE    MAIN 68000 RUNS IN A MUSASHI INTERPRETER WITH ORIGINAL TILEMAP TEXT SPRITE AND SCROLL RAM PRESENTED THROUGH AN 864 BY 486 RTG SCREEN    ROMS ARE LOADED AT RUNTIME FROM YOUR SHARED ROM FOLDER    PRESS FIRE OR START WHEN READY    ",
...
static void draw_ui_frame(void)
{
    ...
    if (dispX >= 190) {
        static const char *const lines[] = {
            "GOLDEN AXE", "", "ARROWS MOVE", "SPACE ATTACK", "ALT JUMP", "",
