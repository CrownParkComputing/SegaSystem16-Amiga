/* shinobi_rtg_main.c -- Alien Syndrome (System 16B) RTG/chunky 864x486 presenter.
 *
...
static uint8_t shinobi_dsw1 = 0xff, shinobi_dsw2 = 0xfd;  /* aliensyn defaults: 1C/1C, demo on, 3 lives, timer 150, normal */
...
/* Alien Syndrome DSW2 (from `mame -listxml aliensyn`); DSW1 coinage is identical
 * to Shinobi so shinobi_coin_a/b are reused. */
static const ai_dip_opt shinobi_demo[] = { {0x02,"OFF"}, {0x00,"ON"} };
static const ai_dip_opt shinobi_lives[] = { {0x08,"2"}, {0x0c,"3"}, {0x04,"4"}, {0x00,"FREE PLAY"} };
static const ai_dip_opt shinobi_timer[] = { {0x00,"120"}, {0x10,"130"}, {0x20,"140"}, {0x30,"150"} };
static const ai_dip_opt shinobi_diff[] = { {0x80,"EASY"}, {0xc0,"NORMAL"}, {0x40,"HARD"}, {0x00,"HARDEST"} };
static const ai_dip_item shinobi_dip_items[] = {
    ...
    {"TIMER",1,0x30,4,shinobi_timer},
    {"DIFFICULTY",1,0xc0,4,shinobi_diff}
};
...
static const char *shinobi_intro_status(void *ctx)
{
    ...
    return "LOADING ALIEN SYNDROME ROMS";
}
...
static const ai_config shinobi_intro_cfg = {
    "ALIEN SYNDROME",
    "WHITTY ARCADE PRESENTS ALIEN SYNDROME    SEGA 1987 SYSTEM 16B HARDWARE    MAIN 68000 RUNS IN A MUSASHI INTERPRETER WITH ORIGINAL TILEMAP TEXT SPRITE AND SCROLL RAM PRESENTED THROUGH AN 864 BY 486 RTG SCREEN    ROMS ARE LOADED AT RUNTIME FROM YOUR SHARED ROM FOLDER    PRESS FIRE OR START WHEN READY    ",
