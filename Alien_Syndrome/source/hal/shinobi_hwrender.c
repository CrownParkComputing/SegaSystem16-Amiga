...
#define NTILES (0x10000/8)          /* 8192 -- aliensyn tile planes are 64KB (half of Shinobi's 128KB) */
...
#define SPR_NUMBANKS (0x80000/0x20000)   /* aliensyn has 4 sprite banks (0x80000 region), same as Shinobi */
